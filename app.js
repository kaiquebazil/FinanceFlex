...
document.addEventListener('DOMContentLoaded', () => {
    ...
    addIncomeBtn.addEventListener('click', () => {
        transactionModalTitle.textContent = 'AdicionarNova Receita';
    ...
    transactionType.addEventListener('change', (e) => {
        if (e.target.value === 'transfer') {
            transactionModalTitle.textContent = 'AdicionarTransferência';
            transferAccountGroup.style.display = 'block';
        } else if (e.target.value === 'income') {
            transactionModalTitle.textContent = 'AdicionarNova Receita';
            transferAccountGroup.style.display = 'none';
        } else {
            transactionModalTitle.textContent = 'AdicionarNova Despesa';
            transferAccountGroup.style.display = 'none';
        }
    });
